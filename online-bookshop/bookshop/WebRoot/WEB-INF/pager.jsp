...
<script type="text/javascript">
	function _go() {
		...
		location = "${pageContext.request.contextPath }/client/ShowController?current=" + pc;
	}
</script>
		...
		<c:forEach begin="${begin }" end="${end }" var="i" varStatus="status">
			<c:choose>
				...
				<c:otherwise>
					...
					<a
						href="${pageContext.request.contextPath }/client/ShowController?current=${status.index}">${status.index }</a>
				</c:otherwise>
			</c:choose>
